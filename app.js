    ...
    return (
      <div className="flex items-center justify-center h-screen bg-gradient-to-br from-blue-50 to-indigo-100">
        <div className="text-center bg-white p-8 rounded-lg shadow-lg">
          ...
          <h2 className="text-2xl font-bold text-gray-800 mb-2">Error Loading App</h2>
      ...
      <div className="max-w-3xl mx-auto">
        ...
        <div className="bg-white rounded-lg shadow-xl p-4 sm:p-8">
          ...
          <div className="text-center mb-8">
            <div className="text-4xl sm:text-6xl font-bold mb-4 text-gray-800">
              {currentWord.thai}
            </div>
            <div className="text-gray-600 italic text-base sm:text-lg">
              {currentWord.meaning}
            </div>
          </div>
              ...
              <div key={index} className="border-2 border-gray-200 rounded-lg p-4 sm:p-6">
                  ...
                  {Object.entries(TONE_INFO).map(([tone, info]) => {
                    ...
                    return (
                      <button
                        ...
                        disabled={showResult}
                        className={`
                          py-2 sm:py-3 px-2 rounded-lg font-semibold transition-all text-sm sm:text-base
                ...
                {showResult && userAnswers[index] !== syllable.tone && (
                  <div className="mt-3 text-sm text-gray-600">
                    Correct: <span className="font-semibold">{TONE_INFO[syllable.tone].name} ({syllable.tone})</span>
                  </div>
                )}
              </div>
            ))}
          ...
          <div className="grid grid-cols-5 gap-2 sm:gap-3">
            {Object.entries(TONE_INFO).map(([tone, info]) => (
              <div key={tone} className="flex flex-col items-center">
                <div className={`${info.color} text-white w-10 h-10 sm:w-12 sm:h-12 rounded-lg flex items-center justify-center font-bold mb-1`}>
                  {tone}
                </div>
        ...
        <div className="mt-6 text-center text-sm text-gray-600">
          <p>Total vocabulary: {vocabulary.length} words</p>
        </div>
      </div>
    </div>
  );
