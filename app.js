...
// Icon components using Unicode/Emoji instead of Lucide
const Icon = {
  Shuffle: (props) => h('span', props, '🔀'),
  Check: (props) => h('span', props, '✓'),
  X: (props) => h('span', props, '✗'),
  RotateCcw: (props) => h('span', props, '↻'),
  Trophy: (props) => h('span', props, '🏆')
};
...
function ThaiToneQuiz() {
  ...
  if (error) {
    return h('div', {
      ...
      h(Icon.X, { className: 'text-6xl text-red-500 mx-auto mb-4' }),
    ...
    h('div', { className: 'max-w-3xl mx-auto' },
      ...
      showFeedback && recentResults.length === 20 && h('div', {
        ...
        h('div', { className: 'flex items-center gap-3 mb-2' },
          h(Icon.Trophy, { className: 'text-3xl' }),
              ...
              h('div', { className: 'flex items-center justify-between mb-4' },
                ...
                showResult && h('div', { className: 'flex items-center gap-2' },
                  userAnswers[index] === syllable.tone
                    ? h(Icon.Check, { className: 'text-green-500 text-3xl' })
                    : h(Icon.X, { className: 'text-red-500 text-3xl' })
                )
              ),
        ...
        h('div', { className: 'mt-8 flex gap-4' },
          !showResult
            ? h('button', {
                ...
                h(Icon.Check, { className: 'text-xl' }),
                ' Check Answers'
              )
            : h('button', {
                onClick: nextWord,
                ...
                h(Icon.Shuffle, { className: 'text-xl' }),
                ' Next Word'
              ),
          h('button', {
            onClick: resetQuiz,
            ...
            h(Icon.RotateCcw, { className: 'text-xl' }),
